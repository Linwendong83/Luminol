 ...
 * Runs on the destination region, once for the successfully transferred root entity.
 * Cancelled or failed transfers, end gateways, and respawn-based End returns do not fire this event.
 */
