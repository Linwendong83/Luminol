 ...
 * Runs on the entity's owning region. Cancellation prevents the portal transfer.
 * End gateways and the player's respawn-based return from the End are not part of this event.
 */
