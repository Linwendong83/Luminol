 ...
 * Runs on the spectator's owning region. The target may belong to another region;
 * use {@link #getDestination()} instead of reading the target's live location.
 * Cancelling prevents the transfer and completes it as unsuccessful.
 */
